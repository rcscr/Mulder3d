...
import rcs.mulder.utils.Freezable;
import rcs.mulder.utils.ImmutableModificationException;
...
public class Vector4d implements Freezable<Vector4d> {   
  ...
  public Vector4d(Vector3d vector3d, double w) {
    set(vector3d.x(), vector3d.y(), vector3d.z(), w);
  }
  ...
  public Vector3d perspectiveDivide() {
    double w = 1.0 / z();
    return new Vector3d(x() * w, y() * w, 1.0);
  }

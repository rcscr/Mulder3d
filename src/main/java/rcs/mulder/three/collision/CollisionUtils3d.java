...
public class CollisionUtils3d { 
  ...
  public static <T extends Collidable3d & MulderGarbageCollectable, U extends Collidable3d> void forEachCollision(
      MulderCollection<T> collection,
      U object, 
  ...
  public static <T extends Collidable3d & MulderGarbageCollectable> void forEachCollision(
      MulderCollection<T> collection,
  ...
  public static <T extends Collidable3d & MulderGarbageCollectable> void forEachCollision(
      MulderCollection<T> collectionA,
      MulderCollection<T> collectionB,
      CollisionHandler3d<T, T> collisionHandler) {
